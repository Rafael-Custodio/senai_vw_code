...
export function exercicio4() {
    ...
    let numero: number = parseInt(prompt("Digite um número inteiro de 0 a 10: "))
    ...
    for (let i: number = 0; i <= 10; i * numero) {
...
export function exercicio9() {
    ...
    let numero: number = parseInt(prompt("Digite um número de 1 a 50: "))
