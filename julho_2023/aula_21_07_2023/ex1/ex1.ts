...
// Para rodar no terminal-> npx ts-node nome_do_arquivo.ts
...
import { exercicio1, exercicio2, exercicio3, exercicio4, exercicio5, exercicio6, exercicio7, exercicio8, exercicio9, exercicio10 } from "./moduloEx1";
...
do {
    ...
    resposta = prompt("Digite um número de 1 a 10 para escolher um exercício, ou 'sair' para sair: ")
